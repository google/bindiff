...
#ifndef DATABASE_INITIALIZE_TABLES_POSTGRESQL_SQL_H_
#define DATABASE_INITIALIZE_TABLES_POSTGRESQL_SQL_H_
...
#endif  // DATABASE_INITIALIZE_TABLES_POSTGRESQL_SQL_H_
