...
#ifndef DATABASE_INITIALIZE_CONSTRAINTS_POSTGRESQL_SQL_H_
#define DATABASE_INITIALIZE_CONSTRAINTS_POSTGRESQL_SQL_H_
...
#endif  // DATABASE_INITIALIZE_CONSTRAINTS_POSTGRESQL_SQL_H_
