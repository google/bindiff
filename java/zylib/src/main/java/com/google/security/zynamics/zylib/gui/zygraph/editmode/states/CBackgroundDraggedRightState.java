...
public class CBackgroundDraggedRightState implements IMouseState {
  private final CStateFactory<?, ?> m_factory;

  private final AbstractZyGraph<?, ?> m_graph;

  public CBackgroundDraggedRightState(final CStateFactory<?, ?> factory,
  ...
  public IMouseStateChange mouseReleased(final MouseEvent event, final AbstractZyGraph<?, ?> graph) {
    return new CStateChange(m_factory.createBackgroundClickedRightState(event), true);
  }
}
