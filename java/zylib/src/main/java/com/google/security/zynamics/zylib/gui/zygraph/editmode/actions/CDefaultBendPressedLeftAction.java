...
public class CDefaultBendPressedLeftAction implements IStateAction<CBendPressedLeftState> {
  @Override
  public void execute(final CBendPressedLeftState state, final MouseEvent event) {
