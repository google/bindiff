...
public class MouseTreeNodeSelectionHandlerCombinedFunction {
  private static void selectGraphNode(final CombinedCallGraphFunctionTreeNode clickedNode) {
    final CombinedCallGraphRootTreeNode rootTreeNode = clickedNode.getRootNode();
    final CombinedCallGraphBaseTreeNode baseTreeNode =
        (CombinedCallGraphBaseTreeNode) clickedNode.getParent();
  ...
  private static void selectGraphNodeCtrl(final CombinedCallGraphFunctionTreeNode clickedNode) {
    final CombinedCallGraphRootTreeNode rootTreeNode = clickedNode.getRootNode();
    final CombinedCallGraphBaseTreeNode baseTreeNode =
        (CombinedCallGraphBaseTreeNode) clickedNode.getParent();
  ...
  private static void selectGraphNodeCtrlShift(
      final CombinedCallGraphFunctionTreeNode clickedNode) {
    final CombinedCallGraphRootTreeNode rootTreeNode = clickedNode.getRootNode();
    final CombinedCallGraphBaseTreeNode baseTreeNode =
        (CombinedCallGraphBaseTreeNode) clickedNode.getParent();
    ...
    if (lastSelectedGraphNode == null) {
      ...
      for (int i = 1; i < baseTreeNode.getChildCount(); ++i) {
        final CombinedCallGraphFunctionTreeNode treeNode =
            (CombinedCallGraphFunctionTreeNode) baseTreeNode.getChildAt(i);
  ...
  private static void selectGraphNodeShift(final CombinedCallGraphFunctionTreeNode clickedNode) {
    final CombinedCallGraphRootTreeNode rootTreeNode = clickedNode.getRootNode();
    final CombinedCallGraphBaseTreeNode baseTreeNode =
        (CombinedCallGraphBaseTreeNode) clickedNode.getParent();
  ...
  public static void handleMouseSelectionEvent(
      final MouseEvent event, final CombinedCallGraphFunctionTreeNode clickedNode) {
